...
var Frap = function Frap(sk, noframes) {
  ...
  //this.sendq = [] //Pending Write
  this.sendq = new Dequeue() //Pending Write
...
function Frap__resume() {
  //if (this.eventq.length > max_eventq) max_eventq = this.eventq.length
  //log("Frap__resume: #eventq=%d; #max_eventq=%d", this.eventq.length, max_eventq)
  var self = this
...
Frap.prototype.destroySoon = function Frap__destroySoon() {
  ...
  var self = this
  if (this.sendq.length > 0 || this._wstream) {

...
function Frap__pause() {
  ...
  //FrapReader.prototype.pause.call(this)
  this.sk.pause()
}
...
function Frap__resume() {
  ...
  process.nextTick(function(){
    Frap.super_.prototype.resume.call(self)
    if (!self.paused) self.sk.resume()
  })
}
...
Frap.prototype.pipe = function Frap__pipe(dst) {
  ...
  function pipeOnHeader(framelen){
    var rstream = src.createReadStream(framelen)
      , wstream = dst.createWriteStream(framelen)
